...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        ...
        <div class="col-6 mt-5">
            <a class="btn bg-gradient-dark mb-0" href=" {{ route('equipement.create') }} "><i class="fas fa-plus"></i>&nbsp;&nbsp;New Equipment</a>
        </div>
                    ...
                    @foreach ($equipements as $equipement)
                        <tr>
                            <td class="align-middle text-center">
                                <span class="text-secondary font-weight-bold"> {{ $equipement->name }} </span>
                            </td>
                            <td class="align-middle text-center text-sm">
                                <span class="text-secondary font-weight-bold"> {{ $equipement->date }} </span>
                            </td>
                            {{-- <td class="align-middle text-center">
